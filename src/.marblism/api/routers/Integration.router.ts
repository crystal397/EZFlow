...
export default function createRouter<Config extends BaseConfig>(router: RouterFactory<Config>, procedure: ProcBuilder<Config>) {
    return router({
        ...
        createMany: procedure.input($Schema.IntegrationInputSchema.createMany).mutation(async ({ ctx, input }) => checkMutate(db(ctx).integration.createMany(input as any))),
        ...
        deleteMany: procedure.input($Schema.IntegrationInputSchema.deleteMany).mutation(async ({ ctx, input }) => checkMutate(db(ctx).integration.deleteMany(input as any))),
        ...
        findFirst: procedure.input($Schema.IntegrationInputSchema.findFirst).query(({ ctx, input }) => checkRead(db(ctx).integration.findFirst(input as any))),

        findMany: procedure.input($Schema.IntegrationInputSchema.findMany).query(({ ctx, input }) => checkRead(db(ctx).integration.findMany(input as any))),
