...
export default function createRouter<Config extends BaseConfig>(router: RouterFactory<Config>, procedure: ProcBuilder<Config>) {
    return router({
        ...
        createMany: procedure.input($Schema.WorkflowInputSchema.createMany).mutation(async ({ ctx, input }) => checkMutate(db(ctx).workflow.createMany(input as any))),
        ...
        deleteMany: procedure.input($Schema.WorkflowInputSchema.deleteMany).mutation(async ({ ctx, input }) => checkMutate(db(ctx).workflow.deleteMany(input as any))),
        ...
        findFirst: procedure.input($Schema.WorkflowInputSchema.findFirst).query(({ ctx, input }) => checkRead(db(ctx).workflow.findFirst(input as any))),

        findMany: procedure.input($Schema.WorkflowInputSchema.findMany).query(({ ctx, input }) => checkRead(db(ctx).workflow.findMany(input as any))),
